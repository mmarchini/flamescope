...
def generate_flame_graph(filename, file_type, range_start, range_end, package_name=False, flavor='standard'):
    ...
    if file_type == 'perf':
        ...
        return nflxprofile_generate_flame_graph(file_path, range_start, range_end, package_name, flavor)
    else:
